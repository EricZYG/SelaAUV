...
const String API_NAME = '分页查询聊天记录';
const String API_PATH = '/user/msg/getMsgRecords';
const String API_METHOD = 'GET';
const bool NEED_SIGN = false;

Future<Map<String, dynamic>> getMsgRecords({
  int? otherUserId,
  String? offsetId,
...
void main() async {
  ...
  try {
    ...
    final result = await getMsgRecords(pageSize: 20);
