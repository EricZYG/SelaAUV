...
const String API_NAME = '获取访客列表';
const String API_PATH = '/user/user/getUserSeeVo';
const String API_METHOD = 'GET';
const bool NEED_SIGN = false;

Future<Map<String, dynamic>> getUserSeeVo({int? size}) async {
...
void main() async {
  ...
  try {
    ...
    final result = await getUserSeeVo(size: 10);
