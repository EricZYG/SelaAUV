...
const String API_NAME = '获取用户背包道具列表';
const String API_PATH = '/user/prop/getUserPropVo';
const String API_METHOD = 'GET';
const bool NEED_SIGN = false;

Future<Map<String, dynamic>> getUserPropVo() async {
...
void main() async {
  ...
  try {
    ...
    final result = await getUserPropVo();
