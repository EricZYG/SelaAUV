...
const String API_NAME = '获取用户详情（我的页面）';
const String API_PATH = '/user/user/getUserDetail';
...
void main() async {
  ...
  try {
    ...
    final result = await getUserDetail();
    ...
    if (result['code'] == 0) {
      ...
      print('剩余钻石: ${data['remainDiamonds']}');
      print('今日已签到: ${data['signFlag'] == 1 ? "是" : "否"}');
    } else {
      print('\n结果: 失败');
