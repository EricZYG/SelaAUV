...
const String API_NAME = '获取标签配置';
const String API_PATH = '/system/app/getTagConfigs';
const String API_METHOD = 'GET';
const bool NEED_SIGN = false;

Future<Map<String, dynamic>> getTagConfigs() async {
...
void main() async {
  ...
  try {
    ...
    final result = await getTagConfigs();
