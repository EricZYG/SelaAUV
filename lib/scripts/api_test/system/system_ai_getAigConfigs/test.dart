...
const String API_NAME = '获取招呼话术列表';
const String API_PATH = '/system/ai/getAigConfigs';
const String API_METHOD = 'GET';
const bool NEED_SIGN = false;

Future<Map<String, dynamic>> getAigConfigs() async {
...
void main() async {
  ...
  try {
    ...
    final result = await getAigConfigs();
