...
const String API_NAME = '获取匹配主播（不扣款）';
const String API_PATH = '/user/anchor/tryGetMatchAnchor';
const String API_METHOD = 'GET';
const bool NEED_SIGN = false;

Future<Map<String, dynamic>> tryGetMatchAnchor() async {
...
void main() async {
  ...
  try {
    ...
    final result = await tryGetMatchAnchor();
