...
/// 获取 RTM Token
Future<String?> fetchRtmToken(HttpClient client) async {
  final response = await client.get(ApiRoutes.rtmToken);
...
void main() async {
  ...
  final outputFile = 'api_debug_${ApiRoutes.rtmTokenName}_$timestamp.txt';

  final client = HttpClient();
  final result = await fetchRtmToken(client);

  if (result != null && client.lastRequest != null && client.lastResponse != null) {
