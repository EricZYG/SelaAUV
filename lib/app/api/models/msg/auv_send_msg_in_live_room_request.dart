...
///
/// 用于在直播间中发送实时消息
class AuvSendMsgInLiveRoomRequest {
  /// 接收者id，固定传0
  ...
  /// 创建文字消息
  static AuvSendMsgInLiveRoomRequest textMessage({
    required String channelId,
    required String content,
    String? jsonData,
  }) {
    return AuvSendMsgInLiveRoomRequest(
      channelId: channelId,
      type: 11,
  ...
  /// 创建图片消息
  static AuvSendMsgInLiveRoomRequest imageMessage({
    required String channelId,
  ...
  /// 创建视频消息
  static AuvSendMsgInLiveRoomRequest videoMessage({
    required String channelId,
  ...
  /// 创建语音消息
  static AuvSendMsgInLiveRoomRequest voiceMessage({
    required String channelId,
