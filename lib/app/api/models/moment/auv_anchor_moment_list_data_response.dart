...
class AuvAnchorMomentItemResponse {
  ...
  factory AuvAnchorMomentItemResponse.fromJson(Map<String, dynamic>? json) {
    if (json == null) return AuvAnchorMomentItemResponse();
    return AuvAnchorMomentItemResponse(
